...
proc selectIcons {} {
   ...
   set LIBRARY [tk_getOpenFile -initialdir [pwd] -initialfile tkIcons -title "Select Icon Library" -filetypes {{"Icon Libraries" {tkIcons*}} {"All Files" {*}}}]
